...
class PageController {
    ...
    loadPage(pokemons) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            pokemons.results.forEach((value) => __awaiter(this, void 0, void 0, function* () {
                const pokeInfo = yield this.api.getPokemon(value.name);
                ...
                page === null || page === void 0 ? void 0 : page.appendChild(element);
            }));
        });
    }
